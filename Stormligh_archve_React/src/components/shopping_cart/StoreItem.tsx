...
function showCancelModal(setQuantity: (qty: number) => void) {
    return (
        <WarningModal
            isOpen={true}
            title="Clear Cart"
...
export function StoreItem({id, name, description, price, image}: StoreItemProps) {
...
const [showModal, setShowModal] = useState(false);
  ...
  const handleCancel = () => setShowModal(false);
    ...
    return (
        <Card>
          <Card.Img variant="top" src={image} height="100px" style={{ objectFit: "cover" }} />
